...
Switch to **jira-story-reader** mode with no issue key override, so it runs its default query:
...
Do not switch to solution-architect, bug-fixer, or any implementation mode — this prompt only
